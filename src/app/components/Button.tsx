...
export const SecondaryButton = ({ prefix, children, onClick }: {
    ...
    return <div>
        <button onClick={onClick} type="button" className="flex text-white bg-blue-800 hover:bg-blue-900 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-800 dark:hover:bg-blue-700 dark:focus:ring-blue-700 dark:border-blue-700">
            <div className="">
                {prefix}
            </div>
            <div className="">
